...
nbatches = 500           # Number of batches for training data
threads = 8                # Number of threads for data loading
neg_ent = 25               # Number of negative entities to sample

# Model Hyperparameters
dim = 50                 # Dimensionality for embeddings (used in both TransE and TransR)
dim_e = 50                # Dimensionality of entity embeddings (TransR)
dim_r = 50                # Dimensionality of relation embeddings (TransR)

# Training Parameters
train_times_transe = 1       # Number of training epochs for TransE
train_times_transr = 500     # Number of training epochs for TransR
...
transr.save_checkpoint('./checkpoint/lastfm_v2.ckpt')

# test the model
transr.load_checkpoint('./checkpoint/lastfm_v2.ckpt')
